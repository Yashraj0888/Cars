...
const CarCard = ({ car }: CarCardProps) => {
    ...
    const carRent = calculateRent(car);

    const mpgToKmpl = (mpg: number): number => {
        const milesToKm = 1.60934;
        const gallonToLiters = 3.78541;
        return +(mpg * (milesToKm / gallonToLiters)).toFixed(2); // Return a number
    };
            ...
            <div className='relative flex w-full mt-2'>
                <div className='flex group-hover:invisible w-full justify-between text-grey'>
                    ...
                    <div className="car-card__icon">
                        ...
                        <p className="car-card__icon-text">{mpgToKmpl(city_mpg)} KMPL</p>
                    </div>
                </div>
